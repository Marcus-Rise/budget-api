...
describe('UserController', () => {
  ...
  describe('me', () => {
    it('should return user dto', async () => {
      ...
      const user = await controller.me({ user: { id: 1, username: '', roles: [] } });
    ...
    it('should throw not found exception', async () => {
      ...
      await expect(controller.me({ user: { id: 1, username: '', roles: [] } })).rejects.toThrow(
        NotFoundException,
      );
    });
  });
  ...
  describe('remove', () => {
    it('should remove user', async () => {
      await controller.remove({ user: { id: 1, username: '', roles: [] } });
